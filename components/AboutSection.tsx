      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
          ...
          <div className="w-full lg:w-1/2 mt-12 lg:mt-0">
            ...
            >
              <p>
                From simple maintenance to complete engine rebuilds, AutoFix Pro provides elite-level car servicing that prioritizes quality, precision, and longevity. We believe every vehicle deserves meticulous attention and premium parts.
              </p>
              <p>
